...
AP.product.items = (function () {
    ...
    var getSortablePlaceholder = function (element) {
        return element.clone().addClass("sortable-placeholder").height(element.height()).width(element.width());
    };
    ...
    var getSortableHint = function (element) {
        ...
        ele.text(text).height(element.height()).width(element.width()).addClass("sortable-hint");

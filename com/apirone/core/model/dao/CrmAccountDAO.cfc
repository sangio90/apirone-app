<cfcomponent extends="com.apirone.core.model.dao.AbsDAO" accessors="true">
	...
	<!---
		Legge dalla tabella locale sincronizzata dal CRM (crm_accounts), non più
		dal vivo via CrmApiService. La forma del ritorno resta identica a quella
		che CrmApiService.getCustomer()/searchCustomers() restituivano, così
		CustomerService/CrmMapper non cambiano.
	--->
	...
	<cffunction name="get" access="public" returntype="Struct">
		...
		<cfquery name="local.q" datasource="apirone">
			SELECT data
			FROM crm_accounts
			WHERE id = <cfqueryparam cfsqltype="varchar" value="#arguments.accountId#">
		</cfquery>

<cfoutput>
    ...
    <div id="product-images-list-modal" class="modal fade">
            ...
            <div class="modal-content">
                ...
                <form id="documents-form" name="documents-form" autocomplete="off">
                    ...
                    <header class="card-header">
                        <h2 class="card-title">Carica immagini combinazione</h2>
                    </header>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row"
                            ...
                            data-template="product-images-combination-tmpl">
                        </div>
        ...
        #template("jstemplate/product/product-images-combination-tmpl")#

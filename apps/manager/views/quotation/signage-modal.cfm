                            ...
                            <div class="col-2">
                                ...
                                <div class="col-sm-10">
                                    <select id="signangeProductCategory"
                                        ...
                                        data-bind="source: categories, value: detailForm.data.signageConfig.catalogBundle.category, events: { change: onCategoryChanged }"
                                        data-value-field="id"
                            ...
                            <div class="col-2" data-bind="visible: detailForm.data.signageConfig.catalogBundle.category.id">
                                ...
                                <div class="col-sm-10">
                                    <select id="signageLine"
                                        ...
                                        data-bind="source: lines, value: detailForm.data.signageConfig.catalogBundle.line, events: { change: onLineChanged }"
                                        data-value-field="id"
                                        data-text-field="name"
                                        data-filter="contains"
                                        >
                            ...
                            <div class="col-2" data-bind="visible: detailForm.data.signageConfig.catalogBundle.line.id">
                                ...
                                <div class="col-sm-10">
                                    <select id="signageModel"
                                        ...
                                        data-bind="source: models, value: detailForm.data.signageConfig.catalogBundle.model, events: { change: onModelChanged }"
                                        data-value-field="id"
                                        data-text-field="name"
                                        data-filter="contains"
                                        >

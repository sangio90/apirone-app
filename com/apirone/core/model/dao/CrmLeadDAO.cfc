<cfcomponent extends="com.apirone.core.model.dao.AbsDAO" accessors="true">
	...
	<!---
		Legge dalla tabella locale sincronizzata dal CRM (crm_leads), non più
		dal vivo via CrmApiService. La forma del ritorno resta identica a quella
		che CrmApiService.getLead()/searchLeads() restituivano, così LeadService/
		CrmMapper non cambiano.
	--->

	<cffunction name="get" access="public" returntype="Struct">
		<cfargument name="leadId" type="String" required="true">

		<cfquery name="local.q" datasource="apirone">
			SELECT data
			FROM crm_leads
			WHERE id = <cfqueryparam cfsqltype="varchar" value="#arguments.leadId#">
		</cfquery>

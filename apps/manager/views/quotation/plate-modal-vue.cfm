            ...
            <div class="modal-content">
                ...
                <!--- Punto di montaggio dell'applicazione Vue 2. L'istanza Vue gestisce tutti i dati e gli eventi del form. --->
                    ...
                    <!--- Form principale. method="POST" per compatibilità server-side. I dati vengono inviati lato server tramite chiamata AJAX dal codice Vue, non da submit nativo. --->
                                            ...
                                            <div class="col-12">
                                                <div class="row mb-2">
                                                    ...
                                                    <!--- position: relative: necessario per posizionare il dropdown dei suggerimenti posizione in absolute. --->
                                                        <input class="form-control form-control-sm" name="position" placeholder="Posizione" id="qt-plate-position-suggest" maxlength="15" v-model="positionSearchTerm" @input="onPositionSearchInput" @blur="syncPositionFromSearchTerm" @keydown.enter.prevent autocomplete="off">
                        ...
                        <div v-if="showJsonPanel" class="row mx-0 border-top pt-2 pb-1">
                            <div class="col-12">
                                <textarea class="form-control form-control-sm" style="font-size:10px; font-family:monospace; height:220px;" :value="jsonExportText" readonly @click="$event.target.select()"></textarea>
                            </div>
                        </div>

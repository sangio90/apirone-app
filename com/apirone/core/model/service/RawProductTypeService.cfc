component extends="com.apirone.core.model.service.AbsService" accessors="true" {
	...
	property name="dao" inject="RawProductTypeDAO";
	property name="statusService" inject="StatusService";

	property name="cacheScope" type="String" default="RawProductType.bean";

	public com.apirone.core.model.bean.RawProductType function get( required String rawProductTypeId ){
	...
	public com.apirone.core.model.bean.Result function search(
		...
		for ( var record in records ) {
			rows.add( get( rawProductTypeId = record.product_category_id ) );
		}
	...
	*/
	...
	private com.apirone.core.model.bean.RawProductType function build( required String rawProductTypeId ){

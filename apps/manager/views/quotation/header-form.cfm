								...
								<div class="col-6">
									...
									<cfif prc.isEditing>
										...
										<div class="d-flex align-items-center mb-3">
											<label class="control-label text-end col-3 me-3">Versione</label>
											<span class="form-control" data-bind="text: detailForm.data.versionNumber"></span>
										</div>

										<div class="d-flex align-items-center mb-3">
											<label class="control-label text-end col-3 me-3">Numero</label>
									...
									<div class="d-flex align-items-center mb-3">
										<label class="control-label text-end col-3 me-3">Descrizione</label>
										<div class="col-9">
									...
									<div class="d-flex align-items-center mb-3">
										<label class="control-label text-end col-3 me-3">Lingua </label>
										<div class="col-9">
									...
									<div class="d-flex align-items-center mb-3">
										<label class="control-label text-end col-3 me-3">Cliente </label>
										<div class="col-9">
									...
									<div class="d-flex align-items-center mb-3">
										<label class="control-label text-end col-3 me-3">Opportunità</label>
										<div class="col-9">
									...
									<div class="d-flex align-items-center mb-3">
										<label class="control-label text-end col-3 me-3">Lead</label>
										<div class="col-9">
									...
									<div class="d-flex align-items-center">
										<label class="control-label text-end col-3 me-3"></label>
										<div class="col-9">
									...
									<div class="d-flex align-items-center mb-3">
										<label class="control-label text-end col-3 me-3">Data documento</label>
										<div class="col-9">
									...
									<div class="d-flex align-items-center mb-3">
										<label class="control-label text-end col-3 me-3">Data validità</label>
										<div class="col-9">
											<input type="date" class="form-control" 
									...
									<div class="d-flex align-items-center mb-3">
										<label class="control-label text-end col-3 me-3">Nota</label>
										<div class="col-9">
											<textarea name="note" class="form-control" rows="2" 
												data-bind="value: detailForm.data.notes"></textarea>
										</div>
									</div>

...
<nmscript type="text/x-kendo-template" id="quotation-item-signage-preview-tmpl">
    <div class="quotation-item m-1 col-3" data-uid="#: uid #" style="cursor: pointer" data-bind="click:editSignage">

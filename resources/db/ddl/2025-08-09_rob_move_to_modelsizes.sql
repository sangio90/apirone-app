...
CREATE TABLE public.signage_configs (
    ...
    linemodel_id UUID STORAGE PLAIN,
    ...
    CONSTRAINT signage_configs_linemodel_id_fk FOREIGN KEY (linemodel_id) REFERENCES public.linemodels (linemodel_id) ON DELETE NO ACTION ON UPDATE CASCADE NOT DEFERRABLE
);

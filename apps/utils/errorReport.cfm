...
<cfsavecontent variable="report">
    ...
    <style>
        h1, span { font-family: Verdana, Helvetica, sans-serif; }
        h1 { font-size: 22px; }
    </style>
    ...
    <div style="padding:10px">
        <h1 style="padding:0;margin:0;padding-bottom: 6px">
            Error 500
            <span style="font-weight: normal; font-size: 12px; background-color: ##FFD700; padding: 5px 10px; border-radius: 5px;">Code: <b>#code#</b></span>
        </h2>
    ...
    <div class="cb-container">
        <div class="extended">
            ...
            <cfif ArrayLen( oException.getTagContext() )>
                <cfset local.firstError = oException.getTagContext()[1]>
            <cfelse>
                <cfset local.firstError = structNew()>
                <cfset local.firstError.Template = "N/A">
                <cfset local.firstError.codePrintHTML = "N/A">
            </cfif>
            ...
            <table class="table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        #encodeForHTML( oException.getmessage() ).listChangeDelims( '<br>', chr(13)&chr(10) )#
                    </td>
                </tr>
                <tr>
                    <td align="right" class="info"><strong>Template:</strong></td>
                    <td>
                        <b style="color:green;">#local.firstError.Template#</b><br>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="info"><strong>Line:</strong></td>
                    <td>
                        <pre>#local.firstError.codePrintHTML#</pre>
                    </td>
                </tr>
                <cfif oException.getExtendedInfo() neq "">
                    <tr>
                        ...
                        <td>
                            #encodeForHTML( oException.getExtendedInfo() )#
                        </td>
                    </tr>
                </cfif>
                ...
                <tr>
                    <td align="right" class="info" nowrap><strong>Route Name: </strong></td>

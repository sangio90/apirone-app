AP.lineDetail = AP.lineDetail || {};

AP.lineDetail.fields = {
    root: $("#product-components-root"),
}

$(document).ready(function(){

	if ( AP.lineDetail.fields.rootDetail.length ) {

		AP.lineDetail.detail.init();

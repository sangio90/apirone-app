...
<script type="text/x-kendo-template" id="quotation-item-accessory-preview-tmpl">
    <div class="quotation-item m-1" data-uid="#: uid #" style="cursor: pointer" data-bind="click:editAccessory">
        <div class="quotation-item-inner">
            <div class="row">
                <div class="col-12 d-flex justify-content-center mb-2" style="font-size: 14px; font-weight: bold;">
                    <div>
                        Anteprima Accessorio
                    </div>

                        ...
                        <div class="tab-pane p-2 fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                            ...
                            <form id="user-detail-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group pb-3">
                                            <label class="col-form-label" for="user-desc">Nome</label>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group pb-3">
                                            <label class="col-form-label" for="user-desc">Lingua</label>
                                            <select required
                                                class="form-control"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group pb-3">
                                            <label class="col-form-label" for="user-desc">Stato</label>
                        ...
                        <div class="tab-pane p-2 fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <form id="user-password-form">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="user-desc">Password</label>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="user-desc">Conferma password</label>

...
<cfoutput>
    <nmscript type="text/x-kendo-template" id="attribute-list-row-tmpl">
        <tr class="k-master-row" data-uid="##: uid ##">
            ...
            <td>
                <button type="button" class="btn btn-default btn-sm me-2" data-bind="click:addAttribute">Aggiungi</button>
            </td>
            <td>

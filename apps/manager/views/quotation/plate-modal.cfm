                            ...
                            <div class="col-2">
                                ...
                                <div class="pricing-box h-100">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-8">
                                            <div class="input-group">
                                                &euro; <span data-format="0.00" data-bind="value: pricing.data.subtotalBeforeFlat"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-8">
                                            <input class="form-control" name="discount2" 
                                                placeholder="%" data-bind="value: pricing.flatDiscount">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-8">
                                            <div class="input-group">
                                                &euro; <span data-format="0.00" data-bind="value: pricing.data.total"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-5">
                                            <select name="priceMethod" class="form-control" id="input-price-method"
                                                data-bind="value: pricing.data.pricing.method, events: { change: changeMethod }"
                                                data-value-field="id"
                                                data-text-field="name"
                                                >

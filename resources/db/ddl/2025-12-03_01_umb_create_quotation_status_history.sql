...
ALTER TABLE files
  ADD CONSTRAINT files_quotation_status_history_id_fk FOREIGN KEY (quotation_status_history_id)
    REFERENCES quotation_status_history(quotation_status_history_id)
    ON DELETE CASCADE
    ON UPDATE CASCADE
    NOT DEFERRABLE; 